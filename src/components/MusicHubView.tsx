  ...
  return (
    <div className="flex flex-col gap-0 animate-fade-in -mx-4 md:-mx-8 -mt-6">
      ...
      <section className="relative h-[55vh] min-h-[380px] max-h-[520px] w-full flex items-end overflow-hidden">
        ...
        {/* Ambient glow orbs */}
        <div className="absolute top-10 right-20 w-96 h-96 bg-[#00f2ff]/5 rounded-full hidden md:block blur-[100px] pointer-events-none" />
        <div className="absolute -bottom-20 -left-10 w-80 h-80 bg-pink-500/5 rounded-full hidden md:block blur-[80px] pointer-events-none" />
